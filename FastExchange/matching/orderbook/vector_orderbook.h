...
public:
     ...
     * @inheritdoc
     */
    [[nodiscard]] inline uint32_t minAskPrice() const override
    {
        return min_ask_price;
    }

    /**
     * @inheritdoc
     */
    [[nodiscard]] inline uint32_t maxBidPrice() const override
    {
...
private:
     ...
     */
    void verifyPriceLevelState(const PriceLevel &price_level, uint32_t expected_price, OrderSide expected_order_side) const;
